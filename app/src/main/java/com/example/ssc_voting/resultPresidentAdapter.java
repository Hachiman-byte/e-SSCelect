...
public class resultPresidentAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    public resultPresidentAdapter(Context context, List<CandidatesData> dataList) {
