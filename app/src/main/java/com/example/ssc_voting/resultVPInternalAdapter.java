...
public class resultVPInternalAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    public resultVPInternalAdapter(Context context, List<CandidatesData> dataList) {
