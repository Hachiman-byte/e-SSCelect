...
public class resultTreasurerAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    public resultTreasurerAdapter(Context context, List<CandidatesData> dataList) {
