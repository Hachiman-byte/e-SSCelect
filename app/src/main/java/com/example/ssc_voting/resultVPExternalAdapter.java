...
public class resultVPExternalAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    public resultVPExternalAdapter(Context context, List<CandidatesData> dataList) {
